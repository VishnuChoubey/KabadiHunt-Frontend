...
// You can extract the style into this file
...
const ScrapCollectorOrders = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await fetch(`/api/orders/${localStorage.getItem("user_id")}`, {
                    method: "GET",
                    headers: {
     ...
     console.log("Fetching orders data...",items);
    const logout = async () => {
        try {
                                    ...
                                    items.map((item, index) => (
                                        <tr key={index}>
                                           ...
                                           <td>
                                            ...
                                            <td>
                                                <button>
                                                    <a href={`/scraprequest-details/${item.orderId}/`}>Inspect</a>
                                                </button>
                                            </td>
                                        </tr>
                                    ))
