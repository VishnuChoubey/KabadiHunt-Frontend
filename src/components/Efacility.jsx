...
const Efacility = () => {
    ...
    useEffect(() => {
        ...
        const fetchRooms = async () => {
            try {
                setLoading(true);
                const res = await axios.get("api/owner/all"); // Use your actual API endpoint
                setRooms(res.data);
                ...
                <div className="row">
                    ...
                    <div className="col-1">
                        ...
                        {filteredRooms?.map((items) => (
                                 console.log(items),
                            <div className="facility-card" key={items.organisationId}>
                                <div className="facility-header">
                                    <img
                                        src={items.imagePath ? `http://localhost:8080${items.imagePath}` : "../assets/default.jpg"}
                                        alt="Facility"
                                        className="facility-image"
                                    />
                                    <h3 className="org-name">
                                        {items.organisationName.toUpperCase()}
                                    </h3>
                                </div>
                                ...
                                <a href={`recycle_main/${items.organisationId}`}>Book Recycling</a>
                            </div>
                        ))}
                    </div>
                    <div className="col-2">
