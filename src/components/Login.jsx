        ...
        username = username.includes(" ")
            ...
            try {
                const response = await axios.post("/api/auth/authenticate", {
                  ...
                  withCredentials: true // include this if you're using cookies or allowCredentials = true
                });
                ...
                if (response.status === 200) {
                  ...
                  alert(data.error || 'Login failed. Please try again. vishnu');
                }
              } catch (error) {
                console.error('Login error:', error);
                alert('Login failed. Please try again. satyem');
              }
