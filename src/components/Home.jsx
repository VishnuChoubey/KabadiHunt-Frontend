...
const Home = () => {
    ...
    const questions = {
        "What is KabadiHunt?": "KabadiHunt is a smart scrap management platform that connects households with verified scrap collectors for seamless waste disposal at fair prices.",
        ...
        "Can I check scrap prices before selling?": "Yes, KabadiHunt provides real-time metal price updates, ensuring that users get the best possible rates.",
        "How does KabadiHunt work?": "Users upload scrap details or images, and the platform classifies them using machine learning. A nearby collector is assigned, and users receive real-time notifications until the scrap is picked up."
    };
        ...
        <div>
            <div className="content">
                <div className="content-left">
                    ...
                    <h3>
                        KabadiHunt : Transforming Waste management. Find Waste facilities <br />
            ...
            <div className="about" id="about">
                <p>-About KabadiHunt</p>
                <h1>Making a revolution in Trash</h1>
                <br /><br />
                <div className="about-area">
                    <div className="about-left">
                        <p>
                            Welcome to KabadiHunt, your dedicated partner in tackling the global e-waste crisis. Our
                            ...
                            <b>Our Mission</b>
                            <br />
                            At KabadiHunt, we are committed to:
